        ...
        <div className="relative h-full pt-8 select-none">
            ...
            <div className="flex flex-col mx-4 mt-4 justify-between relative">
                <div className="font-medium text-center">
                    ...
                    <span>It started with linear and logistic regression to understand basic predictive modeling, then  
                ...
                <img src="/ImageClassifierwNN/fnn.png" className="w-50 m-auto mt-4 hidden md:block"/>
